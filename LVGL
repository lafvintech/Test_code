...
//uint16_t calData[5] = { 3586, 270,  3550,248, 3 };//定义标定参数
uint16_t calData[5] = { 248, 3632,  255,3550, 3 };//定义标定参数
TFT_eSPI tft = TFT_eSPI(screenHeight, screenWidth); /* TFT实例 ，通过旋转成为480*320*/
